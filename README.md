...
針對桌球的技戰術分析，本團隊已開發出桌球智慧球拍，用以蒐集選手揮拍資料，啟動了桌球大數據的研究，能夠深入分析球員回擊方式與揮拍力道是否穩定，提高選手實力評估的精準度，參賽者將運用選手揮拍資料訓練模型，進行性別、持拍手、球齡與選手等級分類。期盼透過本競賽，誠摯邀集具機器學習、數據分析專長的專家與高手，訓練出高辨識率的選手分級模型，進而推動並普及桌球技戰術分析相關研究與應用。<br><br>


## 實作過程簡介
本次競賽的目標是運用由智慧桌球拍所蒐集的揮拍數據，透過 AI 模型來預測選手的四項屬性，包括：性別、慣用手、打球年資、球技等級。<br>
而我將本次競賽的實作過程簡單分為以下幾個部份去講解:<br><br>
